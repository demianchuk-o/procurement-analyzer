...
KEYWORD_FIELD_MAP = {
  "0": "Законодавство і регулювання тендерів",
  "1": "Будівельні роботи та дорожній ремонт",
  "2": "Постачання товарів і контрактні зобов’язання",
  "3": "Фінансові гарантії та банківське забезпечення",
  "4": "Технічні вимоги до товарів та змін документації",
  "5": "Оцінка пропозицій та кваліфікація учасників",
  "6": "Умови виконання договорів і ціноутворення"
}
