...
class TestDiscoveryProzorroClient:
    ...
    @patch('requests.get')
    def test_fetch_search_page_tender_ids_success_page_0(self, mock_get):
    ...
    @patch('requests.get')
    def test_fetch_search_page_tender_ids_success_page_1(self, mock_get):
    ...
    @patch('requests.get')
    def test_fetch_search_page_tender_ids_http_error(self, mock_get):
    ...
    @patch('requests.get')
    def test_fetch_search_page_tender_ids_request_exception(self, mock_get):
    ...
    @patch('requests.get')
    def test_fetch_search_page_tender_ids_schema_validation_error(self, mock_get):
        ...
        # Assert
        # Validation error - result is returned, no retries
        assert result is None
    ...
    @patch('requests.get')
    def test_fetch_tender_bridge_info_success(self, mock_get):
        ...
        assert result["generalClassifier"]["description"] == "Some Category"
    ...
    @patch('requests.get')
    def test_fetch_tender_bridge_info_http_error(self, mock_get):
    ...
    @patch('requests.get')
    def test_fetch_tender_bridge_info_request_exception(self, mock_get):
    ...
    @patch('requests.get')
    def test_fetch_tender_bridge_info_schema_validation_error(self, mock_get):
        ...
        mock_response.json.return_value = {
            "tenderID": ocid,
            "dateModified": "2024-01-15T10:30:00+02:00",
